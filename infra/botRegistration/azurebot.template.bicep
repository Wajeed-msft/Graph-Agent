...
resource botServicesMicrosoftGraphConnection 'Microsoft.BotService/botServices/connections@2022-09-15' = {
  ...
  properties: {
    ...
    // TODO: Replace with workload-specific scopes
    // Example for Calendar: 'Calendars.Read,Calendars.ReadWrite,User.Read'
    // Example for Teams: 'Team.ReadBasic.All,Team.Create,User.Read'
    // Example for SharePoint: 'Sites.Read.All,Sites.ReadWrite.All,User.Read'
    // Example for OneDrive: 'Files.Read,Files.ReadWrite,User.Read'
